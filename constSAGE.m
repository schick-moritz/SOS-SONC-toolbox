function [const,decompVec] = constSAGE(coeff, exponents, indInnerTerms)
% CONSTSAGE computes the relative entropy programming constraint set, which
% can be used to decide, if a given polynomial lies in the polynomial SAGE,
% or equivalently in the SONC cone.
%
...
%   programming constraint set of the SAGE cone, which certifies if the
...
%
%   Output: 
%   - const: The constraint set for the SAGE cone.
