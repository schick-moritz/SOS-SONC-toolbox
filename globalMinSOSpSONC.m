function [val, problem, fSOS, fSONC, hSOS, decompVec, hSONC] = ...
...
%   comes from a call to 'constSONC'.
...
[constSONCcone, decompVec] = constSONC(coeffSONC, exponentsNew, indInnerTerms);

%% Assemble the full constraint set.
const = [...
    (coefficients(fConst - fSOS - fSONC, vecVar) == 0): 'decomposition',...
    (constSONCcone): 'SONC constraints',...
    (Q>=0): 'SOS constraint'];
